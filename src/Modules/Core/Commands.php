...
class Commands 
{
    public static $aCommands = [
        ...
        \Hightemp\WappTestSnotes\Modules\Core\Commands\ListControllers::class,
        \Hightemp\WappTestSnotes\Modules\Core\Commands\ListControllersMethods::class,
        ...
        \Hightemp\WappTestSnotes\Modules\Core\Commands\ListModels::class,
    ];
}
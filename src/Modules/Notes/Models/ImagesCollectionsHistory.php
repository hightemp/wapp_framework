...
define('T_IMAGES_COLLECTIONS_HISTORY', 'timagescollectionshistory');

class ImagesCollectionsHistory extends BaseModel
{
    static $sTableName = T_IMAGES_COLLECTIONS_HISTORY;
